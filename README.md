...
[Стартовый код для реализации проекта](https://replit.com/@Netology-cp/Diplom-startovyi-kod). Страница отобржается во вкладке **result**, отладочная информация во вкладке **console**.
